function main(){
    ...
    glMatrix.mat4.lookAt(viewmatrix,//matriks view
        [0.0, 0.0, 1.5],//posisi kamera (posisi)
        [0.0, 0.0, -5.0],//arah kamera menghadap (vektor)
        [0.0, 2.0, 0.0]//arah atas kamera (vektor)
        );
    ...
    // Event listener for when the mouse is pressed
    ...
    canvas.addEventListener("mousemove", function(event) {
        ...
        // You may need to adjust the scaling factor depending on the size of your object and the desired speed of movement
        var scale = 0.01;
        var translation = glMatrix.vec3.create();
        glMatrix.vec3.set(translation, deltaX * scale, -deltaY * scale, 0);
        glMatrix.mat4.translate(modmatrix, modmatrix, translation);
